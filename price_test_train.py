...
def main():
    ...
    parser.add_argument("testset", help="the name of datasets in price")
    parser.add_argument("--num_queries", help="number of training queries (default: 10000)", type=int, default=10000)
    parser.add_argument("--train_queries", help="the path of training queries", type=str, default='')
    parser.add_argument("--test_queries", help="the path of testing queries", type=str, default='')
    ...
    train_and_predict(args.testset, args.num_queries, args.train_queries, args.test_queries, args.epochs, args.batch, args.hid, args.cuda)
